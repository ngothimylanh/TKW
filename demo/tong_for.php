...
<body>
    ...
    <form action="tong_for.php" method="post" >
        <table width="728" border="1">
            ...
            <tr><td colspan="5">Kết quả<label for="textfield3"></label></td></tr>
            <tr>
                <td>Tổng các số</td>
            ...
            <tr><td colspan="5"><input type="submit" name="button" id="button" value="Tính toán"/></td></tr>
        </table>
    </form>
</body>
</html>