    ...
    <form action="" method="post" enctype="multipart/form-data" name="form1">
        <table align="left" width="400">
            ...
            <tr><td align="right">&nbsp;</td>
                ...
                <input type="hidden" name="ten_anh" value="<?php echo $d['icon'];?>"></td>
            </tr>
            <tr>
                <td align="right"><input type="hidden" name="idTL" value="<?php echo $_GET['idTL'];?>" />
                                <input type="submit" name="Sua" value="Sua"/></td>
